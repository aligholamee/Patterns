...
sample_set = np.concatenate((np.random.normal(modal1_mean, modal1_variance, int(0.5 * NUM_SAMPLES)),
                            np.random.normal(modal2_mean, modal2_variance, int(0.5 * NUM_SAMPLES))))[:, np.newaxis]
